...
namespace FLB 
{
  ...
  __global__ void d_FreeSurface2D_1(PRECISION* d_f, const PRECISION* d_rho, const PRECISION* d_u, const uint8_t* d_flags, PRECISION* d_mass, PRECISION* d_excessMass, PRECISION* d_phi, const unsigned long int t);
  ...
  /** 
    ...
    */
  template<typename PRECISION, int NUMVELOCITIES>
  __global__ void d_FreeSurface2D_3(PRECISION* d_f, PRECISION* d_rho, PRECISION* d_u, uint8_t* d_flags, const unsigned long int t);
